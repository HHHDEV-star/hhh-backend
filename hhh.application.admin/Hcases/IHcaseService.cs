...
public interface IHcaseService
{
    ...
    /// </summary>
    Task<HcaseListResponse> GetListAsync(
    ...
    /// </summary>
    Task<HcaseMutationResult> CreateAsync(
    ...
    /// 排序欄位 corder 不在此處理。
    /// </summary>
    Task<HcaseMutationResult> UpdateAsync(
        uint id,
    ...
    /// </summary>
    Task<HcaseMutationResult> UpdateSortOrderAsync(
