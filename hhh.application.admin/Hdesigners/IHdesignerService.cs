...
public interface IHdesignerService
{
    ...
    /// </summary>
    Task<HdesignerListResponse> GetListAsync(
    ...
    /// </summary>
    Task<HdesignerMutationResult> CreateAsync(
    ...
    /// </summary>
    Task<HdesignerMutationResult> UpdateAsync(
        uint id,
    ...
    /// </summary>
    Task<HdesignerMutationResult> UpdateSortOrderAsync(
    ...
    /// 更新 mobile_order 欄位。
    /// </summary>
    Task<HdesignerMutationResult> UpdateMobileSortOrderAsync(
        UpdateHdesignerSortOrderRequest request,
        CancellationToken cancellationToken = default);
}
