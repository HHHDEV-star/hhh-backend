...
/// <summary>
/// 更新競賽報名請求(PUT /api/hcontests/{id},application/json)。
/// </summary>
/// <remarks>
/// 對應舊版 _hcontest_edit.php 的編輯分支。欄位與 CreateHcontestRequest 相同;
/// id 由 route 帶入,不在 body 內。
/// </remarks>
public class UpdateHcontestRequest
{
